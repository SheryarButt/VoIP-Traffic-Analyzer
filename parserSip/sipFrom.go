 ...
 * DESCRIPTION:
		...
		Package containing functions responible for parsing of SIP Header From field from  packets.
*/
...
/*
 * FUNCTION_NAME: parseSipFrom
 * ARGS:
 *	@_arg1 ([]byte)	: Packet Data in raw bytes.
 *	@_arg2 (sipFrom)	: Pass by reference sipFrom struct.
 * DESCRIPTION: Parsing routine for SIP From header parsing.
 */
