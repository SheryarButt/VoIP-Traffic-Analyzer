 ...
 * DESCRIPTION:
		...
		Package containing functions responible for parsing of SIP Header To field from packets.
*/
...
/*
 * FUNCTION_NAME: parseSipTo
 * ARGS:
 *	@_arg1 ([]byte)	: Packet Data in raw bytes.
 *	@_arg2 (sipTo)	: Pass by reference sipTo struct.
 * DESCRIPTION: Parsing routine for SIP To header parsing.
 */
